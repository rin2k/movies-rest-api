...
exports.CountModel = exports.UserModel = exports.RatingModel = exports.MovieModel = exports.FavoriteModel = exports.CommentModel = void 0;
...
movie_model_1.default.hasMany(count_model_1.default);
count_model_1.default.belongsTo(movie_model_1.default, {
    foreignKey: "movieId",
});
